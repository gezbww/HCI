...
class FaceDiff(nn.Module):
    def __init__(
        ...
        # Audio Encoder
        self.audio_encoder = HubertModel.from_pretrained("pretrained_models/hubert-base-ls960")
        #self.audio_encoder = HubertModel.from_pretrained("facebook/hubert-base-ls960",local_files_only=True)
        self.audio_dim = self.audio_encoder.encoder.config.hidden_size
        self.audio_encoder.feature_extractor._freeze_parameters()
        self.device = args.device
